...
### to test locally
  ...
  If you want to export the emulated data that was used in the backup, run the following command in the firebase console: 
          firebase firestore:export gs://bikebus-71dd5.appspot.com/2024-10-17T17:17:35_8714 --project bikebus-71dd5

          - to import the backup file run: gsutil -D -m cp -r gs://bikebus-71dd5.appspot.com/2024-10-17T17:17:35_8714/* "C:\Users\CraigM\source\repos\bike-bus\firebasebackup\"
...
#### to deploy web to prod firebase hosting
